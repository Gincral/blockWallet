...
export default function Success(props: any) {
    return (
        <div className={styles.body}>
            ...
            <a href="https://etherscan.io/tx/0x6eefc5299ae80d2236d95f7fb58b40fa4a61efacd96e1264431656992b7d51ba" target="_blank" className={styles.link}>view on Ethersacan</a>

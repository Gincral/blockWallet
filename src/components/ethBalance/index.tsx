...
export default function EthBalance(props: any) {
    ...
    return (<div className={styles.body}>
        <div className={styles.content}>
            ...
            <div className={styles.img_background}><img src={img} className={styles.img} onClick={props.onClick}/></div>
            <div className={styles.send} onClick={props.onClick}>Send</div>
        </div>
    </div>)
}